                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="role" class="form-control">
                                    <option value="Kitchen" @if ($staff->role == 'Kitchen') selected @endif>Kitchen
                                    </option>
                                    <option value="Admin" @if ($staff->role == 'Admin') selected @endif>Admin</option>
                                    <option value="Supervisor" @if ($staff->role == 'Supervisor') selected @endif>Supervisor
                                    </option>
                                    <option value="Captain" @if ($staff->role == 'Captain') selected @endif>Captain
                                    </option>
                                    ...
                                    <option value="Manager" @if ($staff->role == 'Manager') selected @endif>Manager
                                    </option>
                                    <option value="Cleaner" @if ($staff->role == 'Cleaner') selected @endif>Cleaner
                                    </option>
                                    <option value="Security" @if ($staff->role == 'Security') selected @endif>Security
                                    </option>
                                </select>
                            </div>
                            {{--
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="idcardnumber" name="idcardnumber" type="text" class="form-control"
                                    placeholder="xxxxx-xxxxxxx-x" maxlength="15" value="{{ $staff->idcardnumber }}"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Salary</label>
