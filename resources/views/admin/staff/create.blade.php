                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('staff.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label>Phone</label>
                                <input name="phone" type="text" class="form-control" placeholder="03XXXXXXXXX"
                                    maxlength="11" value="{{ old('phone') }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="experience" type="number" class="form-control" min="0"
