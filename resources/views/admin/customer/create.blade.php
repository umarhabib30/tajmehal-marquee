            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('customer.store') }}" method="POST" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="phone" name="phone" type="text" class="form-control"
                                    placeholder="03XXXXXXXXX" maxlength="11" value="{{ old('phone') }}" required>
                                @error('phone')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="idcardnumber" name="idcardnumber" type="text" class="form-control"
                                    placeholder="xxxxx-xxxxxxx-x" maxlength="15" value="{{ old('idcardnumber') }}">
                                @error('idcardnumber')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="2ndname" class="col-form-label">Name 2 <small>(optional)</small></label>
                                <input id="2ndname" name="name2" type="text" class="form-control"
                                    placeholder="Enter 2nd person name" value="{{ old('name2') }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="phone2" class="col-form-label">Phone 2</label>
                                <input id="phone2" name="phone2" type="text" class="form-control"
                                    placeholder="Enter 2nd person phone" value="{{ old('phone2') }}" required>
                            </div>
                        </div>
